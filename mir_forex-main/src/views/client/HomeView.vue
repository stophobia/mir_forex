  ...
  <article>
    ...
    <BlockType5 title="Сотрудничество с лицензированной компанией Альфа Форекс">
      <p class="text">
        ...
        участника рынка ценных бумаг Альфа-Форекс, учереждением которой является
        Альфа-Банк.
      </p>
      <p class="text">
        Альфа-Форекс гарантирует безопастность на уровне ведущих мировых банков
        с наивысшим рейтингом и предоставляет нашим клиентам широкий выбор
        инструментов для торговли и лучший сервис.
      </p>
      <p class="text">
        ООО "Альфа-Форекс" имеет лицензию профессионального участника рынка
        ценных бумаг № 045-14070-020000 от 20.12.2018 на осуществление
...
export default {
  ...
  methods: {
    ...
    async call() {
      console.log(document.getElementById("call_name").value);
      console.log(document.getElementById("call_number").value);
