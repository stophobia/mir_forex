        ...
        <div class="container-fuild">
            <div class="row">
                <div class="col-12 text-center p-4" id="student">
                    <h1 class="text-white text-center fw-bolder mb-4" data-aos="fade-up">{{title}}</h1>
                    <p class="text-white text-center fw-light ms-auto me-auto" style="max-width: 600px;" data-aos="fade-up">
                        <slot></slot>
                    </p>
                </div>
            </div>
            <div class="row control justify-content-between">
                <div class="col-3 text-start align-self-center">
                    <div class="row h-100" style="background-image: linear-gradient(to right, rgba(12, 16, 34, 1) 20.17%, transparent);">
                ...
                <div class="col-3 text-end">
                    <div class="row h-100" style="background-image: linear-gradient(-90deg, rgba(12, 16, 34, 1) 20.17%, transparent);">
                        <div class="col align-self-center">
            ...
            <div class="d-flex position-relative corusell" data-aos="fade-up">
                <div class="col-10 col-half col-md-4 p-4 d-none d-sm-none d-md-block"></div>
                <div class="col-10 col-half col-md-4 p-4" v-for="once in cards" :key="once.title">
                    <CustomBlock @supportDataRes='onSupportData'
                        :title = once.title
                        :text = once.text
                    />
                </div>
...
<style scoped>
    ...
    .block::before {
        background-image: linear-gradient(360deg, rgba(12, 16, 34, 1) 32.77%, transparent);
        content: '';
        position: absolute;
        z-index: 0;
        top: 0;
