...
<template>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5 pb-0">
                    ...
                    <div class="mb-3">
                        <input type="phone" :value="number" v-maska data-maska="8 (###) ###-##-##" class="form-control p-3" id="call_number" placeholder="Номер телефона">
                    </div>
                </div>
                <div class="modal-footer text-center p-5 pt-0 border-0">
                    <button type="button" class="btn btn-primary p-3 m-0 mt-4 w-100 mb-3" v-on:click="call()">Заказать звонок</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <a href="https://cbr.ru/finorg/foinfo/?ogrn=1167746614947" target=”_blank” class="btn btn-primary mb-3">Проверить на сайте Цетрального Банка</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="w-100">
                <div class="d-flex">
                    <div class="container text-white">
                        <h1 class="mb-5 fw-bolder">ОФИЦИАЛЬНЫЕ ПРЕДСТАВИТЕЛИ<br>АЛЬФА-ФОРЕКС</h1>
                        <p class="text-muted mb-5">Крупнейший Форекс - дилер с <br>лицензией ЦБ РФ</p>
                        <p class="text-muted mb-5 fw-bold">Оставьте заявку и получите доступ к бесплатному<br>курсу по инвестициям и трейдингу</p>
    ...
    <article>
        ...
        >
            <h5>Мы выходим за рамки традиционного консалтинга, интегрируя инновационные идеи всемирно признанных экспертов в нашу консультативную работу. Благодаря такому подходу наши решения по ваиболее важным и сложным вопросам клиентов разрабатываются индивидуально.</h5>
        </BlockType4>
        <BlockType5 
            title="Сотрудничество с лицензированной компанией Альфа Форекс"
        >
            <p class="text">Компания "МИР" является официальным представителем профессионального участника рынка ценных бумаг Альфа-Форекс, учереждением которой является Альфа-Банк.</p>
            <p class="text">Альфа-Форекс гарантирует безопастность на уровне ведущих мировых банков с наивысшим рейтингом и предоставляет нашим клиентам широкий выбор инструментов для торговли и лучший сервис.</p>
            <p class="text">ООО "Альфа-Форекс" имеет лицензию профессионального участника рынка ценных бумаг № 045-14070-020000 от 20.12.2018 на осуществление деятельности форекс-дилера, выданную Центральным Банком Российской Федерации.</p>
        </BlockType5>
        <BlockType9 
        ...
        >
            <p class="text">Предоставляет возможность получить профессиональное обучение международного стандарта в онлайн или офлайн-формате. Общайтесь с преподавателями на вебинарах, на личных практических занятиях и в чатах. Для вас открыта база знаний со всеми необходимыми материалами.</p>
        </BlockType9>
        ...
        >
            <p class="text" data-aos="fade-up">Онлайн-трейдинг дает возможность торговать валютными парами на рынке Форекс в любое время из любой точки мира. Международный институт рынка использует широкоформатный подход к торговле.</p>
            <p class="text" data-aos="fade-up">Для классической и роботизированной торговли мы используем MetaTrader 5. Для аналитики наши финансовые эксперты используют Trading Viev. Каждая из выше перечисленных платформ подробно изучается на наших занятиях.</p>
