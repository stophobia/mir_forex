        ...
        >
          <Slide class="text-white">
            <h1 class="mb-5 fw-bolder fade-up-1" data-fade-up="true">
              ОФИЦИАЛЬНЫЕ ПРЕДСТАВИТЕЛИ<br />БКС
            </h1>
            <button
              type="button"
          ...
          <Slide class="text-white">
            <h1
              ...
              v-html="
                isMobile
                  ? 'Работать с <br> БКС <br /> Безопасно'
                  : 'Работать с БКС <br /> Безопасно'
              "
            ></h1>
            <button
              type="button"
            ...
            <p class="text-muted mb-5 fw-bold fade-up-3" data-fade-up="true">
              Учреждён Альфа-Банком. Альфа-Банк, крупнейший частный банк в
              России. <br />
          ...
          <Slide class="text-white">
            ...
            <p class="text-muted mb-5 fw-bold fade-up-3" data-fade-up="true">
              Оставь заявку и получи индивидуальное обучение <br />
  ...
  <article>
    ...
    <BlockType5>
      ...
      <p class="text">
        ...
        участника рынка ценных бумаг БКС, учредителем которой является
        Альфа-Банк.
      </p>
      <p class="text">
      ...
      >
        ООО «БКС» имеет лицензию профессионального участника рынка
    ...
    <BlockType6
      ...
      :right_block="{
        title: 'Trading View',
        logo: '/vi.png',
        text: 'TradingView — веб-сервис и социальная сеть для трейдеров, в основе которой лежит платформа технического анализа. Данная платформа предлагает широкий выбор инструментов и оптимизацию многих процессов таких как автоматическое выделение свечных комбинаций, уведомление о движении цены и многое другое.',
      }"
    >
