        ...
        <div class="col-md-6 col-lg-6 col-xl-3 col-12 p-3 card-wrap">
          <div class="card" data-aos="fade-up">
            ...
            <div class="text">
              ...
              <p class="text-muted">
                Данный курс создан для тех кто хочет полноценно освоить сферу
                финансовых рынков и сделать ее основным источником дохода. На
                данном курсе идет изучение всех видов анализа используются все
                временные диапазоны от краткосрочной до долгосрочной торговли,
                изучаются все ведущие инструменты рынка идет
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-6 col-xl-3 col-12 p-3 card-wrap">
          <div class="card" data-aos="fade-up">
            ...
            <div class="text">
              ...
              <p class="text-muted">
                Данный курс нацелен на полную автоматизацию торговых процессов.
                В курс входят роботы по техническому, Фундаментальному и
                индикаторному анализу, а так же полное изучение алгоритмов их
                работы, автоматизация финансового планирования. В данных курс
                также входит материал
              </p>
            </div>
          </div>
        </div>
